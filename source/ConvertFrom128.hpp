...
namespace Langulus::SIMD
{
   ...
   LANGULUS(ALWAYSINLINE) auto ConvertFrom128i(const simde__m128i& v) noexcept {
      ...
      if constexpr (CT::Same<TO, simde__m128>) {
         ...
         if constexpr (CT::SignedInteger8<FT>) {
            if constexpr (CT::SignedInteger8<TT> && S <= 16) {
               // pci8[16] -> pci8[16]                                  
               LANGULUS_ERROR("Can't convert from pci8[16] to pci8[16]");
            }
            else if constexpr (CT::UnsignedInteger8<TT> && S <= 16) {
               // pci8[16] -> pcu8[16]                                  
               LANGULUS_ERROR("Can't convert from pci8[16] to pcu8[16]");
            }
            else if constexpr (CT::SignedInteger16<TT> && S <= 8) {
               // pci8[8] -> pci16[8]                                   
               LANGULUS_ERROR("Can't convert from pci8[8] to pci16[8]");
            }
            else if constexpr (CT::UnsignedInteger16<TT> && S <= 8) {
               // pci8[8] -> pci16[8]                                   
               LANGULUS_ERROR("Can't convert from pci8[8] to pcu16[8]");
            }
            else if constexpr (CT::SignedInteger32<TT> && S <= 4) {
               // pci8[4] -> pci32[4]                                   
               LANGULUS_ERROR("Can't convert from pci8[4] to pci32[4]");
            }
            else if constexpr (CT::UnsignedInteger32<TT> && S <= 4) {
               // pci8[4] -> pcu32[4]                                   
               LANGULUS_ERROR("Can't convert from pci8[4] to pcu32[4]");
            }
            else if constexpr (CT::SignedInteger64<TT> && S <= 2) {
               // pci8[2] -> pci64[2]                                   
               LANGULUS_ERROR("Can't convert from pci8[2] to pci64[2]");
            }
            else if constexpr (CT::UnsignedInteger64<TT> && S <= 2) {
               // pci8[2] -> pcu64[2]                                   
               LANGULUS_ERROR("Can't convert from pci8[2] to pcu64[2]");
            }
            else LANGULUS_ERROR("Can't convert from pci8 to unsupported TT");
         }
         else if constexpr (CT::UnsignedInteger8<FT>) {
            if constexpr (CT::SignedInteger8<TT> && S <= 16) {
               // pcu8[16] -> pci8[16]                                  
               LANGULUS_ERROR("Can't convert from pcu8[16] to pci8[16]");
            }
            else if constexpr (CT::UnsignedInteger8<TT> && S <= 16) {
               // pcu8[16] -> pcu8[16]                                  
               LANGULUS_ERROR("Can't convert from pcu8[16] to pci8[16]");
               ...
               // pcu8[8] -> pci16[8]                                   
               LANGULUS_ERROR("Can't convert from pcu8[8] to pci16[8]");
            }
            else if constexpr (CT::UnsignedInteger16<TT> && S <= 8) {
               // pcu8[8] -> pcu16[8]                                   
               LANGULUS_ERROR("Can't convert from pcu8[8] to pcu16[8]");
            }
            else if constexpr (CT::SignedInteger32<TT> && S <= 4) {
               // pcu8[4] -> pci32[4]                                   
               LANGULUS_ERROR("Can't convert from pcu8[4] to pci32[4]");
            }
            else if constexpr (CT::UnsignedInteger32<TT> && S <= 4) {
               // pcu8[4] -> pcu32[4]                                   
               LANGULUS_ERROR("Can't convert from pcu8[4] to pcu32[4]");
            }
            else if constexpr (CT::SignedInteger64<TT> && S <= 2) {
               // pcu8[2] -> pci64[2]                                   
               LANGULUS_ERROR("Can't convert from pcu8[2] to pci64[2]");
            }
            else if constexpr (CT::UnsignedInteger64<TT> && S <= 2) {
               // pcu8[2] -> pcu64[2]                                   
               LANGULUS_ERROR("Can't convert from pcu8[2] to pcu64[2]");
            }
            else LANGULUS_ERROR("Can't convert from pcu8 to unsupported TT");
         }
         else if constexpr (CT::SignedInteger16<FT>) {
            if constexpr (CT::SignedInteger8<TT> && S <= 8) {
               // pci16[8] -> pci8[8]                                   
               LANGULUS_ERROR("Can't convert from pci16[8] to pci8[8]");
            }
            else if constexpr (CT::UnsignedInteger8<TT> && S <= 8) {
               // pci16[8] -> pcu8[8]                                   
               LANGULUS_ERROR("Can't convert from pci16[8] to pcu8[8]");
            }
            else if constexpr (CT::SignedInteger16<TT> && S <= 8) {
               // pci16[8] -> pci16[8]                                  
               LANGULUS_ERROR("Can't convert from pci16[8] to pci16[8]");
            }
            else if constexpr (CT::UnsignedInteger16<TT> && S <= 8) {
               // pci16[8] -> pcu16[8]                                  
               LANGULUS_ERROR("Can't convert from pci16[8] to pcu16[8]");
            }
            else if constexpr (CT::SignedInteger32<TT> && S <= 4) {
               // pci16[4] -> pci32[4]                                  
               LANGULUS_ERROR("Can't convert from pci16[4] to pci32[4]");
            }
            else if constexpr (CT::UnsignedInteger32<TT> && S <= 4) {
               // pci16[4] -> pcu32[4]                                  
               LANGULUS_ERROR("Can't convert from pci16[4] to pcu32[4]");
            }
            else if constexpr (CT::SignedInteger64<TT> && S <= 2) {
               // pci16[2] -> pci64[2]                                  
               LANGULUS_ERROR("Can't convert from pci16[2] to pci64[2]");
            }
            else if constexpr (CT::UnsignedInteger64<TT> && S <= 2) {
               // pci16[2] -> pcu64[2]                                  
               LANGULUS_ERROR("Can't convert from pci16[2] to pcu64[2]");
            }
            else LANGULUS_ERROR("Can't convert from pci16 to unsupported TT");
         }
         else if constexpr (CT::UnsignedInteger16<FT>) {
            if constexpr (CT::SignedInteger8<TT> && S <= 8) {
               // pcu16[8] -> pci8[8]                                   
               LANGULUS_ERROR("Can't convert from pcu16[8] to pci8[8]");
            }
            else if constexpr (CT::UnsignedInteger8<TT> && S <= 8) {
               // pcu16[8] -> pcu8[8]                                   
               LANGULUS_ERROR("Can't convert from pcu16[8] to pcu8[8]");
            }
            else if constexpr (CT::SignedInteger16<TT> && S <= 8) {
               // pcu16[8] -> pci16[8]                                  
               LANGULUS_ERROR("Can't convert from pcu16[8] to pci16[8]");
            }
            else if constexpr (CT::UnsignedInteger16<TT> && S <= 8) {
               // pcu16[8] -> pcu16[8]                                  
               LANGULUS_ERROR("Can't convert from pcu16[8] to pcu16[8]");
            }
            else if constexpr (CT::SignedInteger32<TT> && S <= 4) {
               // pcu16[4] -> pci32[4]                                  
               LANGULUS_ERROR("Can't convert from pcu16[4] to pci32[4]");
            }
            else if constexpr (CT::UnsignedInteger32<TT> && S <= 4) {
               // pcu16[4] -> pcu32[4]                                  
               LANGULUS_ERROR("Can't convert from pcu16[4] to pcu32[4]");
            }
            else if constexpr (CT::SignedInteger64<TT> && S <= 2) {
               // pcu16[2] -> pci64[2]                                  
               LANGULUS_ERROR("Can't convert from pcu16[2] to pci64[2]");
            }
            else if constexpr (CT::UnsignedInteger64<TT> && S <= 2) {
               // pcu16[2] -> pcu64[2]                                  
               LANGULUS_ERROR("Can't convert from pcu16[2] to pcu64[2]");
            }
            else LANGULUS_ERROR("Can't convert from pcu16 to unsupported TT");
         }
      ...
      else LANGULUS_ERROR("Can't convert from __m128i to unsupported");
   }
