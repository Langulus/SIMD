...
namespace Langulus::SIMD::Inner
{
   ...
   LANGULUS(INLINED)
   constexpr No MinSIMD(CT::NotSIMD auto, CT::NotSIMD auto) noexcept { return {}; }
   ...
   auto MinSIMD(R lhs, R rhs) noexcept {
      ...
      if constexpr (CT::SIMD128<R>) {
         ...
         else if constexpr (CT::Real32<T>)            return R {simde_mm_min_ps      (lhs, rhs)};
         else if constexpr (CT::Real64<T>)            return R {simde_mm_min_pd      (lhs, rhs)};
      ...
      if constexpr (CT::SIMD256<R>) {
         ...
         else if constexpr (CT::Real32<T>)            return R {simde_mm256_min_ps   (lhs, rhs)};
         else if constexpr (CT::Real64<T>)            return R {simde_mm256_min_pd   (lhs, rhs)};
      ...
      if constexpr (CT::SIMD512<R>) {
         ...
         else if constexpr (CT::Real32<T>)            return R {simde_mm512_min_ps   (lhs, rhs)};
         else if constexpr (CT::Real64<T>)            return R {simde_mm512_min_pd   (lhs, rhs)};
